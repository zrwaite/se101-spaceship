...
export default class DefenceController extends SubsystemController{
	defenceUpdate(shipStatusInfo:ShipStatus, aimTurret:(angle:Vector2) => APIResponse, getTubeCooldown:(tube:number) => APIResponse, fireTorpedo:(tube:number) => APIResponse){}
}
