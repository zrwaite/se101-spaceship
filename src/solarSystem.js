        ...
        */
        switch (this.name) {
            case "test":
                ...
                this.planets.push(...[
                    new Planet("planet1", new Composition(0, 0, 0, 0, 0, 0), new Vector2(500, 100), this.game),
                    new Planet("planet2", new Composition(0, 0, 0, 0, 0, 0), new Vector2(100, 500), this.game),
                    new Planet("planet3", new Composition(0, 0, 0, 0, 0, 0), new Vector2(600, 350), this.game),
                    new Planet("planet4", new Composition(0, 0, 0, 0, 0, 0), new Vector2(240, 190), this.game),
                    new Planet("planet5", new Composition(0, 0, 0, 0, 0, 0), new Vector2(330, 440), this.game),
                    new Planet("planet6", new Composition(0, 0, 0, 0, 0, 0), new Vector2(40, 90), this.game),
                    new Planet("planet7", new Composition(0, 0, 0, 0, 0, 0), new Vector2(110, 60), this.game),
                    new Planet("planet8", new Composition(0, 0, 0, 0, 0, 0), new Vector2(140, 230), this.game),
                    new Planet("planet9", new Composition(0, 0, 0, 0, 0, 0), new Vector2(190, 210), this.game),
                    new Planet("planet10", new Composition(0, 0, 0, 0, 0, 0), new Vector2(260, 460), this.game),
                    new Planet("planet11", new Composition(0, 0, 0, 0, 0, 0), new Vector2(370, 270), this.game),
                    new Planet("planet12", new Composition(0, 0, 0, 0, 0, 0), new Vector2(340, 400), this.game),
            ...
            case "Cygni System":
                ...
                this.asteroidLaunchers.push(...[
                    new AsteroidLauncher(this.game, new Vector2(610, 510), 5, 10),
                    new AsteroidLauncher(this.game, new Vector2(210, 20), 4, 12, Math.PI / 4)
                ]);
                this.warpGates.push(...[
            ...
            case "Kepler 438 System":
                ...
                this.planets.push(...[
                    new Planet("planet6", new Composition(0, 0, 0, 0, 0, 0), new Vector2(690, 410), this.game),
                    new Planet("planet4", new Composition(0, 0, 0, 0, 0, 0), new Vector2(80, 130), this.game)
                ]);
                this.warpGates.push(...[
                    new WarpGate("Sol System", new Vector2(140, 370), this.game),
                ]);
                break;
            case "Kruger System":
                this.asteroids.push(...[
                ...
                this.warpGates.push(new WarpGate("Groombridge System", new Vector2(370, 90), this.game), new WarpGate("Aquarii System", new Vector2(110, 400), this.game), new WarpGate("Cygni System", new Vector2(610, 390), this.game));
                break;
            case "Luyten System":
                this.asteroids.push(...[
                ...
                this.planets.push(...[
                    new Planet("planet2", new Composition(0, 0, 0, 0, 0, 0), new Vector2(450, 650), this.game),
                    new Planet("planet1", new Composition(0, 0, 0, 0, 0, 0), new Vector2(80, 80), this.game)
                ]);
                break;
            case "Quaid System":
                // Generate asteroids at modulo offsets (to prevent hard coding large # of asteroids)
                ...
                this.asteroidLaunchers.push(...[
                    new AsteroidLauncher(this.game, new Vector2(80, 50), 4, 15),
                    new AsteroidLauncher(this.game, new Vector2(260, 410), 7, 10)
                ]);
                this.warpGates.push(...[
            ...
            case "Yennefer System":
                this.warpGates.push(new WarpGate("Aquarii System", new Vector2(160, 480), this.game), new WarpGate("Cygni System", new Vector2(480, 160), this.game), new WarpGate("Indi System", new Vector2(50, 160), this.game), new WarpGate("Quaid System", new Vector2(480, 350), this.game));
                break;
        }
    }
    getMapData(pos) {
