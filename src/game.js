...
export default class Game {
    ...
    start(galaxyName, allShips, watchShipName) {
        ...
        if (this.watchShip)
            ...
            throw Error('Watch ship not found');
    ...
    update() {
        ...
        //console.log(this.watchShip.pos.x + ", " + this.watchShip.pos.y);
        ...
        /*let candidateX = this.watchShip.pos.x - this.width / this.zoom / 2;
        let candidateY = this.watchShip.pos.y - this.height / this.zoom / 2;

        console.log(candidateX + ", " + candidateY);
        console.log(this.width + ", " + this.height);*/
        
        this.camera.x = this.zoom === 1 ? 0 : candidateX;
        this.camera.y = this.zoom === 1 ? 0 : candidateY;
        this.frame++;
    }
    draw() {
        if (this.drawnProcess)
            ...
            throw Error('this.drawnProcess not defined');
    }
    endGame() {
        let game = this;
        ...
        for (let i = 0; i < game.processes.length; i++)
            delete game.processes[i];
    }
